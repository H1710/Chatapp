import { FirstStepRegister } from '../models/auth.model';

export const validFirstStep = (firstStepForm: FirstStepRegister) => {
  const { password, confirmPassword } = firstStepForm;
  const errors = [];
